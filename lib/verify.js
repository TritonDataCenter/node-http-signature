...
module.exports = {
  ...
  verifyHMAC: function verifyHMAC(parsedSignature, secret) {
    ...
    var algUpper = alg[1].toUpperCase();
    var hmac = crypto.createHmac(algUpper, secret);
    ...
    // More information can be found here: http://tinyurl.com/doublehmac
    
    var h1 = crypto.createHmac(algUpper, secret);
    h1.update(hmac.digest('base64'));
    var h2 = crypto.createHmac(algUpper, secret);
